...
const updateFamille = async(req, res) => {
    ...
    const response = await FamilleDB.updateFamille(libelle, description, id_famille);
    ...
    return res.status(200).json({ message: `L'famille numéro ${id_famille} a été modifié` });
};
