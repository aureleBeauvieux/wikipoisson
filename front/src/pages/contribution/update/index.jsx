...
const EditContribution = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (actualUser !== undefined && actualUser.role === "user" && actualUser.id === contribution.user_id && contribution.validation === 0) {
      const API_URL = import.meta.env.VITE_API_URL;
      ...
      let config = {
        ...
        url: `${API_URL}/contribution/update/${id}`,
        headers: {
      ...
      <form onSubmit={handleSubmit}>
        <div className="col-sm-6 mx-auto">
          ...
          <div className="mt-4">
            ...
            />
            {imagePreview1 && (
              <img src={imagePreview1} alt="Preview 1" style={{ maxWidth: '200px', marginTop: '10px' }} />
            )}
          </div>
          <div className="mt-4">
            ...
            />
            {imagePreview2 && (
              <img src={imagePreview2} alt="Preview 2" style={{ maxWidth: '200px', marginTop: '10px' }} />
            )}
          </div>
          <div className="mt-4">
            ...
            />
            {imagePreview3 && (
              <img src={imagePreview3} alt="Preview 3" style={{ maxWidth: '200px', marginTop: '10px' }} />
            )}
          </div>
        </div>
